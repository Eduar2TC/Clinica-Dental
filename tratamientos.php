                    ...
                    <div class="parallax-container center valign-wrapper">
                        <div class="parallax">
                            ...
                            <div class="container white-text">
                                <div class="row">
                                    <div class="col s12">
                                        <h1 class="center">Tratamientos</h1>
                                        <h5>Conoce los tratamientos que ofrecemos</h5>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col s12 m4">
                                <div class="card card-resize-height">
                                    <div class="card-image">
                                        ...
                                        <a href="#servicio1" class="btn-floating halfway-fab waves-effect waves-light blue modal-trigger"><i
                            ...
                            <div class="col s12 m4 col-two">
                                <div class="card card-resize-height">
                                    <div class="card-image">
                                        ...
                                        <a href="#servicio2" class="btn-floating halfway-fab waves-effect waves-light blue modal-trigger"><i
                                                class="material-icons">add</i></a>
                                    </div>
                                    <div class="card-content">
    ...
    <script>
        ...
        function dropDownExpand(centinela, selectorIdMasMenos, selectorIdColapso){
            ...
            if (centinela === false) {
                ...
                $("#"+selectorIdColapso).collapsible({ accordion: true });
