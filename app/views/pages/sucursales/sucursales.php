    ...
    <header>
        ...
        <div class="row" id="navegacionPrincipal">
            ...
            <ul class="side-nav" id="mobile-menu">
                <li><a href="main" class="blue-text">Inicio</a></li>
                <li><a href="tratamientos" class="blue-text">Tratamientos</a></li>
                <li><a href="precios" class="blue-text">Precios</a></li>
                <li><a href="sucursales" class="blue-text">Clínicas</a></li>
                <li><a href="#formulario-cita" class="blue-text waves-effect waves-yellow  blue lighten-5 btn modal-trigger">Reservar
                        Cita</a></li>
                <li><a href="main" class="blue-text"><i class="fas fa-sign-in-alt"></i>Login médico</a></li>
            </ul>
