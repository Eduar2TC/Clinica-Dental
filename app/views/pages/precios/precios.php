                ...
                <div class="row">
                    <div id="links-superiores">
                        <ul class="left hide-on-small-and-down">
                            <li><a class="link" href="<?php echo URL_ROOT ?>/pages/contacto">Nosotros</a></li>
        ...
        <div class="row" id="navegacionPrincipal">
            ...
            <ul class="side-nav" id="mobile-menu">
                ...
                <li><a href="#formulario-cita" class="blue-text waves-effect waves-yellow  blue lighten-5 btn modal-trigger">Reservar
                        Cita</a></li>
                <li><a href="<?php echo URL_ROOT ?>/users/login" class="blue-text"><i class="fas fa-sign-in-alt"></i>Login médico</a></li>
            </ul>
                    ...
                    <div class="row" id="carousel-ninios">
                        ...
                        <div class="col s12 m12 l12">
                            <div class="carousel carousel-slider">
                                ...
                                <a class="carousel-item" href="#two!"><img src="<?php echo $path_img ?>ninio01.jpg"></a>
